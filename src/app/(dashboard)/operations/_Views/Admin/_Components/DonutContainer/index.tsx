...
const DonutOperationsContainer = async () => {
  // @ts-expect-error
  const { list } = await getDataOperationsAction();
  return (
    <div className="mb-1 mr-2 flex h-auto w-96 flex-col items-center rounded-lg border-2 border-ligh-gray bg-white py-4 shadow-md xl:w-2/5">
