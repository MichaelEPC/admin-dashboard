...
const EarningsChart = ({ list, years }: props) => {
  ...
  return (
    <div className="min-h-[560px] w-[650px] rounded-lg border-2 border-ligh-gray bg-white p-4 shadow-md">
      <div className="flex items-center justify-between">
        <div className="relative flex h-auto w-72 skew-x-3 items-center rounded-md bg-gradient-to-r from-principal-color to-second-color px-6 py-2 shadow-lg">
