...
import deleteClientsAction from "app/app/(dashboard)/operations/_Views/Admin/utils/DeleteClients";
...
export function ChangeInformation({ id, name, date }: ControlProps) {
